...
//        {
//            return await Task.FromResult(tokens.TryAdd(token.Token, token));
//        }

//        public async Task<bool> RemoveAsync(string refreshToken)
//        {
//            return await Task.FromResult(tokens.TryRemove(refreshToken, out RefreshToken token));
//        }
//    }
//}
